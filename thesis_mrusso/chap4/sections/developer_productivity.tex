...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|l|c|c|c|p{3.5cm}|}
        \hline
        \textbf{Task}                 & \textbf{Workflow}          & \textbf{Manual}        & \textbf{Automated} & \textbf{Speedup}   & \textbf{Notes}                                                                                                          \\
        \hline\hline
        ...
        \hline\hline
        \textbf{Total (End-to-End)}   & Full Pipeline              & \textbf{3.5--4.5 h}    & \textbf{20--30 min} & $\mathbf{9\times}$  & From firmware init to validated AI integration. \\
        \hline
    \end{tabular}%
    }
\end{table}

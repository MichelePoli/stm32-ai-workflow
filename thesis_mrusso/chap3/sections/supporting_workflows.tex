...
\begin{itemize}
    ...
    \item \textbf{Generic Vision Processor}: Automatically discovers image files within heterogeneous directory structures, inferring labels from parent subdirectories. This feature enables zero-configuration processing of arbitrary vision datasets (e.g., Fruit-360) by handling archive extraction and automatic conversion to memory-efficient \texttt{.npy} formats with a capped sampling limit (up to 10,000 images) to prevent RAM exhaustion.

...
\begin{itemize}
    \item \textbf{Dynamic Sampling Escalation}: Instead of training on the full dataset (which might lead to OOM or excessive latency), the system employs a capped sampling strategy (10,000 images). This ensures a balanced representation across classes while maintaining execution speed.

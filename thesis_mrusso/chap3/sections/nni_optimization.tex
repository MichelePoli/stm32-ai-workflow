...
To bridge this gap, we implemented a \textbf{Two-Phase HPO Protocol} that ensures the best performing model is seamlessly transitioned into the firmware integration stage.

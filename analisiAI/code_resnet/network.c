...
#define AI_TOOLS_DATE_TIME   "2026-01-22T17:22:58+0100"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 16, 4, 1, 1), AI_STRIDE_INIT(4, 1, 8, 32, 32),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 5680, 1, 1),
    5680, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 5632);
    dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 5568);
    dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 5664);
    dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 5664);
    return true;
  }

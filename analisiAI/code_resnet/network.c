...
#define AI_NETWORK_MODEL_SIGNATURE     "0x0c10d490e379825ce4518ad91e070202"
...
#define AI_TOOLS_DATE_TIME   "2026-01-04T20:30:08+0100"
...
/* Array#205 */
AI_ARRAY_OBJ_DECLARE(
  adaptive_output_dense_weights_array, AI_ARRAY_FORMAT_LUT4_FLOAT,
...
AI_TENSOR_OBJ_DECLARE(
  ...
  11, 0x0,
  AI_SHAPE_INIT(4, 1280, 10, 1, 1), AI_STRIDE_INIT(4, 1, 640, 6400, 6400),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 8833768, 1, 1),
    8833768, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    adaptive_output_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 8827328);
    ...
    adaptive_output_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 8833728);
    adaptive_output_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 8833728);
    return true;
  }

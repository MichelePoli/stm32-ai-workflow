...
#define AI_NETWORK_MODEL_SIGNATURE     "0x6844e5c6679b8606aa0867c0ef6f16d3"
...
#define AI_TOOLS_DATE_TIME   "2026-01-27T15:53:27+0100"
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    predictions_output_array.data = AI_PTR(g_network_activations_map[0] + 5024);
    predictions_output_array.data_start = AI_PTR(g_network_activations_map[0] + 5024);
    return true;
  }

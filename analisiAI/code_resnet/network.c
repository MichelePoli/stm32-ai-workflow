...
#define AI_TOOLS_DATE_TIME   "2025-11-14T17:36:23+0100"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  181, 0x0,
  AI_SHAPE_INIT(4, 64, 100, 1, 1), AI_STRIDE_INIT(4, 1, 32, 3200, 3200),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 1863760, 1, 1),
    1863760, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 1860160);
    dense_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 1860096);
    dense_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 1863360);
    dense_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 1863360);
    return true;
  }

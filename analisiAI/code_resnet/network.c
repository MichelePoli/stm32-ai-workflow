...
#define AI_TOOLS_DATE_TIME   "2025-11-21T12:21:12+0100"
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 9471328, 1, 1),
    9471328, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    predictions_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 8827328);
    ...
    predictions_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 9467328);
    predictions_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 9467328);
    return true;
  }

    ...
    def initialize(self, args):
        ...
        if VLLM_AVAILABLE:
            self.llm = LLM(
                ...
                # Usa 0.85 per avere abbastanza spazio per pesi + KV Cache (~13.6GB su 16GB) (una votla, quando usavo la GPU in locale!)
                # Mistral e DeepSeek vengono prima scaricati dal triton_client, quindi la VRAM è libera.
                gpu_memory_utilization=0.45, # questa modifica va fatta su HPP, non qui in locale! Adesso model_repository sta su HPP!
                max_model_len=2048,

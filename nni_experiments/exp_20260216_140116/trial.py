...
x_train = np.load(f'/home/mrusso/stm32-ai-workflow/STM32CubeMX/data/real_datasets/cifar10/x_train.npy', mmap_mode='r')
y_train = np.load(f'/home/mrusso/stm32-ai-workflow/STM32CubeMX/data/real_datasets/cifar10/y_train.npy', mmap_mode='r')
x_test = np.load(f'/home/mrusso/stm32-ai-workflow/STM32CubeMX/data/real_datasets/cifar10/x_test.npy', mmap_mode='r')
y_test = np.load(f'/home/mrusso/stm32-ai-workflow/STM32CubeMX/data/real_datasets/cifar10/y_test.npy', mmap_mode='r')
...
# Load model
model = keras.models.load_model('/home/mrusso/.stm32_ai_models/mobilenetv2_a035_224.keras')
